...
export default class restHelper {
   ...
   */
  getSystemStatus() {
    return fetchUtil.get<ISystem.Status>(
      `${this.url}/rest/about/system-status.json`,
      {},
      this.restXhrConfig
    );
  }
   ...
   */
  getVersion() {
    return fetchUtil.get<ISystem.Version>(
      `${this.url}/rest/about/version.json`,
      {},
      this.restXhrConfig
    );
  }
   ...
   */
  getFonts() {
    return fetchUtil.get<ISystem.Fonts>(
      `${this.url}/rest/fonts`,
      {},
      this.restXhrConfig
    );
   ...
   */
  getLoggingConfig() {
    return fetchUtil.get<ISystem.LogConfiguration>(
      `${this.url}/rest/logging.json`,
      {},
      this.restXhrConfig
    );
  }
  ...
  getResourceDirectoryInfo(relativePath: string = "") {
    return fetchUtil.get<IResource.IDirectoryInfo>(
      `${this.url}/rest/resource${relativePath}?format=json`,
      {},
      this.restXhrConfig
    );
  }
  ...
  creatResource(relativePath: string, stringData: string) {
    return fetchUtil.put<string>(
      `${this.url}/rest/resource${relativePath}?operation=default`,
      stringData,
      this.restXhrConfig
    );
  }
  ...
  copyResource(newPath: string, orignPath: string) {
    return fetchUtil.put<string>(
      `${this.url}/rest/resource${newPath}?operation=copy`,
      orignPath,
      this.restXhrConfig
    );
  }
  ...
  moveResource(newPath: string, orignPath: string) {
    return fetchUtil.put<string>(
      `${this.url}/rest/resource${newPath}?operation=move`,
      orignPath,
      this.restXhrConfig
    );
  }
  ...
  deleteResource(relativePath: string) {
    return fetchUtil.delete<string>(
      `${this.url}/rest/resource${relativePath}`,
      {},
      this.restXhrConfig
    );
  }
   ...
   */
  getMasterPassword() {
    return fetchUtil.get<ISecurity.MasterPassword>(
      `${this.url}/rest/security/masterpw.json`,
      {},
      this.restXhrConfig
    );
  }
  ...
  getSecurityRulesOfLayersBased() {
    return fetchUtil.get<ISecurity.SecurityRules>(
      `${this.url}/rest/security/acl/layers.json`,
      {},
      this.restXhrConfig
    );
  }
   ...
   * */
  getRoles() {
    return fetchUtil.get<ISecurity.Roles>(
      `${this.url}/rest/security/roles.json`,
      {},
      this.restXhrConfig
    );
  }
   ...
   *      password: "geoserver",
   *  })
   * restHelperInstance.addRole("roleName").then(res => {
   *  console.log(res)
   * })
   * ```
   * */
  addRole(roleName: string) {
    return fetchUtil.post<string>(
      `${this.url}/rest/security/roles/role/${roleName}`,
      {},
      this.restXhrConfig
    );
  }
   ...
   *      password: "geoserver",
   *  })
   * restHelperInstance.deleteRole("roleName").then(res => {
   *  console.log(res)
   * })
   * ```
   * */
   ...
   * */
  getUsers() {
    return fetchUtil.get<ISecurity.Users>(
      `${this.url}/rest/security/usergroup/users.json`,
      {},
      this.restXhrConfig
    );
  }
   ...
   * ```
   * */
  addUser(addParameters: ISecurity.UserOperateParameters) {
    return fetchUtil.post<string>(
      `${this.url}/rest/security/usergroup/users`,
      addParameters,
      this.restXhrConfig
    );
  }
   ...
   *      password: "geoserver",
   *  })
   * restHelperInstance.modifyUser("userName",
   * {
   *    user:{
   *      userName: "userName",
   *      password: "password",
  ...
  modifyUser(
    userName: string,
    modifyParameters: ISecurity.UserOperateParameters
  ) {
    return fetchUtil.post<string>(
      `${this.url}/rest/security/usergroup/user/${userName}`,
      modifyParameters,
      this.restXhrConfig
    );
  }
   ...
   *      password: "geoserver",
   *  })
   * restHelperInstance.deleteUser("userName").then(res => {
   *  console.log(res)
   * })
   * ```
   * */
  deleteUser(roleName: string) {
    return fetchUtil.delete<string>(
      `${this.url}/rest/security/usergroup/user/${roleName}`,
      {},
      this.restXhrConfig
    );
  }
   ...
   *      password: "geoserver",
   *  })
   * restHelperInstance.getUserRoles("userName").then(res => {
   *  console.log(res)
   * })
   * ```
   * */
  getUserRoles(userName: string) {
    return fetchUtil.get<ISecurity.Roles>(
      `${this.url}/rest/security/roles/user/${userName}.json`,
      {},
      this.restXhrConfig
    );
  }
   ...
   *      password: "geoserver",
   *  })
   * restHelperInstance.addUserRole("userName","roleName").then(res => {
   *  console.log(res)
   * })
   * ```
   * */
  addUserRole(userName: string, roleName: string) {
    return fetchUtil.post<string>(
      `${this.url}/rest/security/roles/role/${roleName}/user/${userName}`,
      {},
      this.restXhrConfig
    );
  }
   ...
   *      password: "geoserver",
   *  })
   * restHelperInstance.deleteUserRole("userName","roleName").then(res => {
   *  console.log(res)
   * })
   * ```
   * */
  deleteUserRole(userName: string, roleName: string) {
    return fetchUtil.delete<string>(
      `${this.url}/rest/security/roles/role/${roleName}/user/${userName}`,
      {},
      this.restXhrConfig
  ...
  getLayerListApi(workspaceName?: string) {
    const queryUrl = workspaceName
      ? `${this.url}/rest/workspaces/${workspaceName}/layers`
      : `${this.url}/rest/layers`;
  ...
  getLayerInfoApi(layerNameWithWorkspace?: string) {
    const realLayerNameWithWorkspace = layerNameWithWorkspace
      ? layerNameWithWorkspace
      : `${this.workspace}:${this.layer}`;
    return fetchUtil.get<ILayer.ResLayerInfo>(
      `${this.url}/rest/layers/${realLayerNameWithWorkspace}`,
      {},
      this.restXhrConfig
    );
  }
  ...
  modifyLayerApi(
    layerName: string,
    layerBody: ILayer.LayerModifyInfo,
    workspaceName?: string
  ) {
    const putUrl = workspaceName
      ? `${this.url}/rest/workspaces/${workspaceName}/layers/${layerName}`
      : `${this.url}/rest/layers/${layerName}`;
    return fetchUtil.put<string>(
      putUrl,
      { layer: layerBody },
      this.restXhrConfig
  ...
  deleteLayerApi(layerName: string, workspaceName?: string) {
    const queryUrl = workspaceName
      ? `${this.url}/rest/workspaces/${workspaceName}/layers/${layerName}.json`
      : `${this.url}/rest/layers/${layerName}.json`;
    return fetchUtil.delete<ILayer.ResLayerGroupInfo>(
      queryUrl,
      {},
      this.restXhrConfig
    );
  ...
  getLayerCacheTasksApi(layerNameWithWorkspace?: string) {
    const realLayerNameWithWorkspace = layerNameWithWorkspace
      ? layerNameWithWorkspace
      : `${this.workspace}:${this.layer}`;
    return fetchUtil.get<ILayer.LayerCacheTasks>(
  ...
  sendLayerCacheTaskApi(seedRequestOption: ILayer.SeedRequest) {
    const realLayerNameWithWorkspace = seedRequestOption.name
      ? seedRequestOption.name
      : this.workspace
      ? `${this.workspace}:${this.layer}`
      : `${this.layer}`;
    ...
    const seedOption = Object.assign(defaultSeedOption, {
      seedRequest: seedRequestOption,
    });
    return fetchUtil.post<string>(
      `${this.url}/gwc/rest/seed/${realLayerNameWithWorkspace}.json`,
      seedOption,
  ...
  clostLayerCacheTaskApi(layerNameWithWorkspace?: string) {
    const realLayerNameWithWorkspace = layerNameWithWorkspace
      ? layerNameWithWorkspace
      : `${this.workspace}:${this.layer}`;
    const tempHeadersConfig = Object.assign(
      { "Content-Type": "application/javascript" },
      JSON.parse(JSON.stringify(this.restXhrConfig.headers))
    );
  ...
  getLayerGroupInfoApi(layergroupName: string, workspaceName?: string) {
    const queryUrl = workspaceName
      ? `${this.url}/rest/workspaces/${workspaceName}/layergroups/${layergroupName}.json`
      : `${this.url}/rest/layergroups/${layergroupName}.json`;
    return fetchUtil.get<ILayer.ResLayerGroupInfo>(
      queryUrl,
      {},
      this.restXhrConfig
    );
  ...
  modifyLayerGroupApi(
    ...
    layerGroupBody: ILayer.LayerGroupModifyInfo,
    workspaceName?: string
  ) {
    const putUrl = workspaceName
      ? `${this.url}/rest/workspaces/${workspaceName}/layergroups/${layergroupName}`
      : `${this.url}/rest/layergroups/${layergroupName}`;
    return fetchUtil.put<string>(
      putUrl,
      { layerGroup: layerGroupBody },
      this.restXhrConfig
    );
  }
   ...
   */
  getWorkspaceListApi() {
    return fetchUtil.get<IWorkspace.WorkspaceList>(
      `${this.url}/rest/workspaces.json`,
      {},
      this.restXhrConfig
    );
  }
  ...
  getWorkspaceInfoApi(workspaceName?: string) {
    return fetchUtil.get<IWorkspace.ResWorkspaceInfo>(
      `${this.url}/rest/workspaces/${workspaceName}`,
      {},
      this.restXhrConfig
    );
  }
  ...
  getDefaultWorkspaceInfoApi() {
    return fetchUtil.get<IWorkspace.ResWorkspaceInfo>(
      `${this.url}/rest/workspaces/default`,
      {},
      this.restXhrConfig
    );
  }
   ...
   */
  updateWorkspaceApi(
    orignWorkspaceName: string,
    body: IWorkspace.WorkspaceOperationForm
  ) {
    return fetchUtil.put<string>(
      `${this.url}/rest/workspaces/${orignWorkspaceName}`,
      { workspace: body },
      this.restXhrConfig
    );
  }
  ...
  getNamespacesInfoApi(namespaceName: string) {
    return fetchUtil.get<INamespaces.NamespaceInfoRes>(
      `${this.url}/rest/namespaces/${namespaceName}`,
      {},
      this.restXhrConfig
    );
  }
  ...
  getStylesListApi(workspaceName?: string) {
    const queryUrl = workspaceName
      ? `${this.url}/rest/workspaces/${workspaceName}/styles`
      : `${this.url}/rest/styles`;
  ...
  getStyleInfoApi(styleName: string, workspaceName?: string) {
    ...
    return fetchUtil.get<IStyle.StyleDetailInfoRes>(
      queryUrl,
      {},
      this.restXhrConfig
    );
  ...
  addStyleApi(body: any, styleName: string, workspaceName?: string) {
    const postUrl = workspaceName
      ? `${this.url}/rest/workspaces/${workspaceName}/styles?name=${styleName}`
      : `${this.url}/rest/styles?name=${styleName}`;
    const tempHeadersConfig = Object.assign(
      JSON.parse(JSON.stringify(this.restXhrConfig.headers)),
      { "Content-Type": "application/vnd.ogc.sld+xml" }
    );
    const tempXhrConfig = Object.assign(
      JSON.parse(JSON.stringify(this.restXhrConfig)),
      {
        headers: tempHeadersConfig,
      }
    );
  ...
  updateStyleApi(
    ...
    const putUrl = workspaceName
      ? `${
          this.url
        }/rest/workspaces/${workspaceName}/styles/${styleName}?style=${
          newStyleName || styleName
        }`
      : `${this.url}/rest/styles/${styleName}?style=${
          newStyleName || styleName
        }`;
    const tempHeadersConfig = Object.assign(
      JSON.parse(JSON.stringify(this.restXhrConfig.headers)),
  ...
  getDatastoreListApi(workspaceName: string) {
    return fetchUtil.get<IDatastore.ResDatastoreList>(
      `${this.url}/rest/workspaces/${workspaceName}/datastores`,
      {},
      this.restXhrConfig
    );
  }
  ...
  getCoveragestoresListApi(workspaceName: string) {
    return fetchUtil.get<IDatastore.ResCoveragestoreList>(
      `${this.url}/rest/workspaces/${workspaceName}/coveragestores`,
      {},
      this.restXhrConfig
    );
  }
  ...
  deleteDatastoreApi(
    ...
    return fetchUtil.delete<string>(
      `${this.url}/rest/workspaces/${workspaceName}/datastores/${storeName}?recurse=${recurse}`,
      {},
      this.restXhrConfig
    );
  }
   ...
   * @returns
   */
  deleteCoverageDatastoreApi(
    workspaceName: string,
    storeName: string,
    recurse: boolean = false
  ) {
    return fetchUtil.delete<string>(
      `${this.url}/rest/workspaces/${workspaceName}/coveragestores/${storeName}?recurse=${recurse}`,
      {},
      this.restXhrConfig
    );
  }
